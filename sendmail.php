...
$mail->Password = 'Q2046391q2w3e4r'; // Ваш пароль от почты с которой будут отправляться письма
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465; // TCP port to connect to / этот порт может отличаться у других провайдеров

$mail->setFrom('rmfighht94@mail.ru'); // от кого будет уходить письмо?
$mail->addAddress('rosrenta@yandex.ru'); // Кому будет уходить письмо
$mail->isHTML(true);   // Set email format to HTML

$name = $_POST['name'];
$tel = $_POST['tel'];

$mail->Subject = 'Пользователь с сайта "ros.rent" заказал звонок!';
